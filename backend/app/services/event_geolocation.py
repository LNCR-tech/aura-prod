"""Use: Contains the main backend rules for event location verification.
Where to use: Use this from routers, workers, or other services when event location verification logic is needed.
